...
export function CardInicial({ setNotaAvaliacao, notaAvaliacao, setSubmited }) {
    function handleSubmit () {
        ...
        alert("Please, select a rating note!")
    }
    ...
    return (
        <div className="bg-gradient-dark text-white mx-6 p-6 rounded-2xl font-overpass max-w-103">
            ...
            <button onClick={handleSubmit} className="bg-orange w-full h-10.5 uppercase tracking-1 font-bold rounded-3xl text-sm py-3 hover:bg-white hover:text-orange hover:cursor-pointer duration-500">Submit</button>
        </div> 
    )
}